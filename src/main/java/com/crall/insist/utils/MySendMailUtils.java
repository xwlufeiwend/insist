...
import com.crall.insist.utils.intrface.MailService;
...
@Component
public class MySendMailUtils implements MailService {

    private final static Logger logger = LoggerFactory.getLogger(MySendMailUtils.class);
